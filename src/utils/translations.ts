...
const en: Translations = {
  ...
  nextStep: 'Next step',
  heroGreeting: 'Hey — I\'m Halo AI.\n\nWe build **AI systems** that handle the repetitive work in your business — so you can focus on what actually matters. Live in **2 weeks**.\n\nWhat\'s taking up most of your time right now?',
  ...
  thinkingLines: [
    ...
    'Finding where the time is going...',
    'Thinking about what could run itself...',
    'Figuring out the quickest win...',
    'Checking what tools you might already use...',
    'Looking at how others in your space have done this...',
    'Working out the best approach for you...',
    'Putting together a clear answer...',
    'Spotting the bottlenecks...',
    'Working out what this could save you...',
    'Thinking through the right setup...',
    'Making sure the numbers add up...',
    'Looking for the low-hanging fruit...',
    'Connecting the dots...',
    'Seeing what fits your goals...',
    'Running through a few scenarios...',
    'Thinking about your specific situation...',
    'Mapping out a simple plan...',
    'Double-checking a few things...',
    'Working out where to start...',
    'Drafting a clear recommendation...',
    'Comparing a few options...',
    'Almost there...',
    'Making sure this actually makes sense for you...',
    'Pulling it all together...',
    'Nearly ready...',
    'One more thing to check...',
    'Putting the finishing touches on...',
    'This will be worth the wait...',
    'Done thinking — here is what I found...',
    'Wrapping up...',
    'Here you go...',
  ],
...
const de: Translations = {
  ...
  heroGreeting: 'Hey — ich bin Halo AI.\n\nWir bauen **KI-Systeme**, die die Routinearbeit in Ihrem Unternehmen übernehmen — damit Sie sich auf das konzentrieren können, was wirklich zählt. Live in **2 Wochen**.\n\nWas kostet Sie gerade am meisten Zeit?',
  ...
  thinkingLines: [
    'Schau mir Ihr Business an...',
    'Finde heraus, wo die Zeit verloren geht...',
    'Überlege, was sich von selbst erledigen könnte...',
    'Suche nach dem schnellsten Gewinn für Sie...',
    'Prüfe, welche Tools Sie vielleicht schon nutzen...',
    'Schaue, wie andere in Ihrer Branche das gelöst haben...',
    'Arbeite den besten Ansatz für Ihren Fall heraus...',
    'Stelle eine klare Antwort zusammen...',
    'Erkenne die größten Zeitfresser...',
    'Rechne aus, was das für Sie bedeutet...',
    'Denke den richtigen Aufbau durch...',
    'Stelle sicher, dass das Sinn ergibt...',
    'Suche nach einfachen ersten Schritten...',
    'Verbinde die Punkte...',
    'Schaue, was zu Ihren Zielen passt...',
    'Spiele ein paar Szenarien durch...',
    'Denke an Ihre spezifische Situation...',
    'Entwerfe einen einfachen Plan...',
    'Überprüfe noch einmal...',
    'Arbeite heraus, wo anzufangen ist...',
    'Formuliere eine klare Empfehlung...',
    'Vergleiche ein paar Optionen...',
    'Fast fertig...',
    'Stelle sicher, dass das wirklich für Sie funktioniert...',
  ...
  growthMappingDesc: 'Kein Verkaufsgespräch. Kein Technik-Vortrag. Nur ein ehrliches Gespräch darüber, wo KI Ihnen wirklich Zeit und Geld spart. Beinhaltet:',
  duration: '30 Min',
  locale: 'de-DE',
...
const fr: Translations = {
  ...
  heroGreeting: 'Hey — je suis Halo AI.\n\nOn construit des **systèmes IA** qui gèrent le travail répétitif dans votre entreprise — pour que vous puissiez vous concentrer sur ce qui compte vraiment. Opérationnel en **2 semaines**.\n\nQu\'est-ce qui vous prend le plus de temps en ce moment ?',
