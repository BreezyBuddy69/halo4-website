...
const en: Translations = {
  ...
  heroSubtitle: 'Your business on autopilot. Custom AI systems, live in 2 weeks — we handle everything.',
  letsTalk: "Let's Talk",
  ...
  talkToIntegratedAI: 'Talk to our Integrated AI',
  nextStep: 'Next step',
  heroGreeting: '— Hello, I\'m Halo AI.\n\nMost businesses waste **20+ hours a week** on tasks that could run on autopilot.\n\nWe build the **AI agents** and **automations** that handle it — custom-made for your business, live in **2 weeks**.\n\nYou focus on growth. The system handles the rest.\n\n✦ Autonomous  ·  Custom-Built  ·  Scalable  ·  24/7',
  ...
  chatGreeting: "Hi, I'm your automation assistant. What's your biggest time drain right now? I'll show you exactly how to automate it.",
  ...
  thinkingLines: [
    'Analyzing your business workflows...',
    'Identifying automation opportunities...',
    'Calculating time-saving potential...',
    'Mapping decision pathways...',
    'Scanning integration compatibility...',
    'Cross-referencing industry benchmarks...',
    'Evaluating AI model suitability...',
    'Structuring intelligent response...',
    'Processing workflow bottlenecks...',
    'Modeling ROI impact scenarios...',
    'Reviewing agent architecture options...',
    'Checking data pipeline integrity...',
    'Optimizing prompt engineering paths...',
    'Synthesizing best practice frameworks...',
    'Aligning with business objectives...',
    'Running efficiency simulation...',
    'Connecting operational data points...',
    'Generating custom strategy outline...',
    'Verifying tool integration options...',
    'Computing automation priority score...',
    'Drafting workflow recommendation...',
    'Benchmarking against similar systems...',
    'Scanning for edge case scenarios...',
    'Calibrating response parameters...',
    'Loading context from previous session...',
    'Building decision tree for your use case...',
    'Reviewing API connectivity options...',
    'Analyzing peak usage patterns...',
    'Estimating deployment timeline...',
    'Compiling final recommendation...',
    'Preparing structured output...',
    'Almost ready with your answer...',
  ],
  servicesTitle: 'What You Get',
  servicesSubtitle: 'We build AI agents tailored to your exact workflows — eliminating manual work, unlocking capacity, and driving revenue you can measure.',
  filterAll: 'All',
  ...
  customBuiltDesc: 'I specialize in turning manual business operations into autonomous revenue engines. Every system is done-for-you — designed, built, connected, and handed over ready to run. Companies I work with reclaim 20+ hours per week, starting from week one.',
  ...
  workWithUsDesc: 'Four clear steps. No tech headaches. Just a system that runs itself while you focus on growth.',
  ...
  growthMappingDesc: 'No pitch. No fluff. Just clarity on where AI saves you time and money. Includes:',
  duration: '30 Min',
  locale: 'en-US',
  ...
  agencyNote: 'For business owners who want results — not tech lessons.',
...
const de: Translations = {
  ...
  heroSubtitle: 'Ihr Unternehmen auf Autopilot. Individuelle KI-Systeme, live in 2 Wochen — wir übernehmen alles.',
  letsTalk: 'Kontakt',
  ...
  talkToIntegratedAI: 'Sprich mit unserer integrierten KI',
  nextStep: 'Nächster Schritt',
  heroGreeting: '— Hallo, ich bin Halo AI.\n\nDie meisten Unternehmen verschwenden **20+ Stunden pro Woche** für Aufgaben, die auf Autopilot laufen könnten.\n\nWir bauen die **KI-Agenten** und **Automatisierungen**, die das übernehmen — maßgeschneidert, live in **2 Wochen**.\n\nSie fokussieren sich aufs Wachstum. Das System erledigt den Rest.\n\n✦ Autonom  ·  Maßgeschneidert  ·  Skalierbar  ·  24/7',
  processTitle: 'Ihr Plan',
  ...
  chatGreeting: 'Hallo, ich bin Ihr Automatisierungs-Assistent. Was kostet Sie gerade am meisten Zeit? Ich zeige Ihnen genau, wie Sie es automatisieren können.',
  ...
  thinkingLines: [
    'Analyse Ihrer Geschäftsabläufe...',
    'Automatisierungspotenziale identifizieren...',
    'Zeitersparnis berechnen...',
    'Entscheidungswege kartieren...',
    'Integrations-Kompatibilität prüfen...',
    'Branchenvergleiche durchführen...',
    'KI-Modell-Eignung bewerten...',
    'Intelligente Antwort strukturieren...',
    'Workflow-Engpässe verarbeiten...',
    'ROI-Szenarien modellieren...',
    'Agenten-Architekturoptionen prüfen...',
    'Daten-Pipeline-Integrität überprüfen...',
    'Prompt-Engineering-Pfade optimieren...',
    'Best-Practice-Frameworks synthetisieren...',
    'Geschäftsziele abgleichen...',
    'Effizienz-Simulation ausführen...',
    'Betriebliche Datenpunkte verbinden...',
    'Individuelle Strategie erstellen...',
    'Tool-Integrationsoptionen prüfen...',
    'Automatisierungsprioritäten berechnen...',
    'Workflow-Empfehlung formulieren...',
    'Mit ähnlichen Systemen vergleichen...',
    'Randfall-Szenarien prüfen...',
    'Antwortparameter kalibrieren...',
    'Kontext aus vorheriger Sitzung laden...',
    'Entscheidungsbaum aufbauen...',
    'API-Verbindungsoptionen prüfen...',
    'Spitzenauslastungsmuster analysieren...',
    'Bereitstellungszeitplan schätzen...',
    'Endempfehlung zusammenstellen...',
    'Strukturierte Ausgabe vorbereiten...',
    'Ihre Antwort ist fast fertig...',
  ],
  servicesTitle: 'Was Sie erhalten',
  servicesSubtitle: 'Wir bauen KI-Agenten, die exakt auf Ihre Abläufe zugeschnitten sind — Routinearbeit wird eliminiert, Kapazitäten freigesetzt, Wachstum messbar gemacht.',
  filterAll: 'Alle',
  ...
  customBuiltDesc: 'Ich bin darauf spezialisiert, manuelle Geschäftsprozesse in autonome Wachstumsmaschinen zu verwandeln. Jedes System wird für Sie komplett umgesetzt — konzipiert, gebaut, verbunden und betriebsbereit übergeben. Die Unternehmen, mit denen ich arbeite, gewinnen ab der ersten Woche 20+ Stunden zurück.',
  rapidDeployment: 'Konzentrieren Sie sich auf Ihr Unternehmen, während intelligente Systeme die operative Arbeit erledigen.',
  workWithUs: 'Bereit für Automatisierung?',
  workWithUsDesc: 'Vier klare Schritte. Kein technischer Aufwand. Nur ein System, das sich selbst betreibt — während Sie wachsen.',
  ...
  growthMappingDesc: 'Kein Verkaufsgespräch. Keine Floskeln. Nur Klarheit darüber, wo KI Ihnen Zeit und Geld spart. Beinhaltet:',
  duration: '30 Min',
  locale: 'de-DE',
  ...
  agencyNote: 'Für Unternehmer, die Ergebnisse wollen — keine Technik-Schulungen.',
  firstName: 'Vorname',
  lastName: 'Nachname',
...
const fr: Translations = {
  ...
  heroSubtitle: 'Votre entreprise en pilote automatique. Systèmes IA sur mesure, opérationnels en 2 semaines — nous gérons tout.',
  letsTalk: 'Parlons-en',
  startJourney: 'Réserver votre audit IA gratuit',
  ...
  talkToIntegratedAI: 'Parlez à notre IA intégrée',
  nextStep: 'Étape suivante',
  heroGreeting: '— Bonjour, je suis Halo AI.\n\nLa plupart des entreprises perdent **20+ heures par semaine** sur des tâches qui pourraient tourner en automatique.\n\nNous construisons les **agents IA** et **automatisations** qui s\'en chargent — sur mesure, opérationnels en **2 semaines**.\n\nVous vous concentrez sur la croissance. Le système gère le reste.\n\n✦ Autonome  ·  Sur mesure  ·  Évolutif  ·  24/7',
  ...
  thinkingLines: [
    'Analyse de vos flux de travail...',
    "Identification des opportunités d'automatisation...",
    'Calcul du potentiel de gain de temps...',
    'Cartographie des chemins de décision...',
    "Vérification de la compatibilité d'intégration...",
    'Comparaison avec les benchmarks sectoriels...',
    "Évaluation de l'adéquation des modèles IA...",
    'Structuration de la réponse intelligente...',
    "Traitement des goulots d'étranglement...",
    'Modélisation des scénarios ROI...',
    "Examen des options d'architecture agent...",
    "Vérification de l'intégrité du pipeline...",
    'Optimisation des chemins de prompt engineering...',
    'Synthèse des frameworks de bonnes pratiques...',
    'Alignement avec les objectifs métier...',
    "Exécution de la simulation d'efficacité...",
    'Connexion des points de données opérationnels...',
    'Génération du plan stratégique personnalisé...',
    "Vérification des options d'intégration d'outils...",
    "Calcul du score de priorité d'automatisation...",
    'Rédaction de la recommandation de workflow...',
    'Comparaison avec des systèmes similaires...',
    'Vérification des scénarios limites...',
    'Calibration des paramètres de réponse...',
    'Chargement du contexte de session...',
    "Construction de l'arbre de décision...",
    "Examen des options de connectivité API...",
    "Analyse des modèles d'utilisation de pointe...",
    'Estimation du calendrier de déploiement...',
    'Compilation de la recommandation finale...',
    'Préparation de la sortie structurée...',
    'Votre réponse est presque prête...',
  ],
  servicesTitle: 'Ce que vous obtenez',
  ...
  workWithUsDesc: 'Quatre étapes claires. Aucune complexité technique. Juste un système qui se gère tout seul pendant que vous grandissez.',
  ...
  growthMappingDesc: 'Pas de discours commercial. Juste une clarté sur où l\'IA vous fait gagner du temps et de l\'argent. Inclut :',
  duration: '30 Min',
  locale: 'fr-FR',
  ...
  agencyNote: "Pour les entrepreneurs qui veulent des résultats — pas des cours de technologie.",
  firstName: 'Prénom',
  lastName: 'Nom',
