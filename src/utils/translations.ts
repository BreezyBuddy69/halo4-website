...
const en: Translations = {
  heroTitle1: 'Your team is doing work software should be doing.',
  heroTitle2: 'Fully Automated.',
  heroSubtitle: 'We build the AI systems that take it over — bookings, follow-ups, inbox triage, lead qualification. Built around how you already work, live in 2 weeks.',
  letsTalk: "Let's Talk",
...
const de: Translations = {
  ...en,
  heroTitle1: 'Ihr Team macht Arbeit, die Software machen sollte.',
  heroTitle2: 'Voll automatisiert.',
  heroSubtitle: 'Wir bauen die KI-Systeme, die sie übernehmen — Termine, Nachfassen, Posteingang, Anfragen-Qualifizierung. Gebaut um Ihre Abläufe herum, in 2 Wochen live.',
  letsTalk: 'Kontakt',
...
const fr: Translations = {
  ...en,
  heroTitle1: 'Votre équipe fait un travail que le logiciel devrait faire.',
  heroTitle2: 'Tout automatisé.',
  heroSubtitle: 'Nous construisons les systèmes IA qui le prennent en charge — rendez-vous, relances, boîte mail, qualification des demandes. Conçu autour de vos processus, opérationnel en 2 semaines.',
  letsTalk: 'Parlons-en',
